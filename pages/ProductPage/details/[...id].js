        ...
        <div className='flex max-w-screen-lg items-center rounded-lg border shadow-2xl'>
           <div className= "h-full w-2/4">
                      { (allImages.length > 0) ?
                            ...
                            :
                             <Skeleton variant="rectangular" width={512} height="500px" className="w-full rounded-3xl h-[500px] cursor-grab mx-auto grid place-content-center text-center text-2xl" >Image not available</Skeleton>
                              }
                            </div>
                                 <div className=' flex flex-col w-2/4 p-10 text-lg gap-4 items-center'>
                                  ...
                                  <span className={`${basicbtn} flex gap-4 hover:bg-green-700 border-green-500`}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 inline">
