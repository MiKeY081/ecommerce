      ...
      <div className="flex ">
        <div className="left-section flex flex-col w-3/4 gap-10 ">
          {products?.map((product) => (
            <div
              key={product._id}
              className="flex border shadow-2xl rounded-lg"
            >
              <Link
              ...
              <div className="flex flex-col w-3/5 p-3 text-lg gap-4 items-center">
                ...
                <h5 className="mt-3 text-lg text-gray-600 overflow-ellipsis line-clamp-6">
                  {product.description}
                </h5>
                <div className="mt-4">
              ...
              <div className="quantity flex flex-col gap-4 items-center justify-center">
                ...
                <div className="flex justify-center items-center gap-8 p-4">
                  <button
                    ...
                    className="bg-slate-500 px-2 py-1 text-lg rounded-lg text-blue-200 w-10 hover:scale-125 hover:bg-green-600 transition-all delay-500"
                  >
                    -
                  </button>
                  <div>
