...
function Header() {
  ...
  return (
    <>
      ...
      <Link href ={'/'} className='hover:scale-110 font-bold text-black text-xl hover:text-blue-300 transition-all duration-200'>E-commmerce</Link>
        ...
        <div>
          <ul className='flex justify-between gap-12 text-gray-900 opacity-100'>
            <li className='hover:scale-110 hover:font-bold text-xl hover:text-blue-300 transition-all duration-200 w-20'>
              <Link href = {"/ProductPage/home"} className=' '>Home</Link>
            </li>
            <li className='hover:scale-110 hover:font-bold text-xl hover:text-blue-300 transition-all duration-200 w-20'>
