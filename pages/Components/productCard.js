    ...
    <div className="CardSection grid grid-cols-4 whitespace-nowrap p-4 gap-8 ">
      {products &&
        products.map((product, index) => (
          <div
            key={index}
            className="flex flex-wrap flex-col shadow-2xl rounded-2xl p-5"
          >
              ...
              {product.image[0] || product.imageLink[0] ? (
                ...
                >
                  <Skeleton
                    ...
                    width={256}
                    height={320}
                    className="w-64 h-80 cursor-pointer rounded-lg mx-auto grid place-content-center text-center text-2xl"
                  >
                    Image not available
                  </Skeleton>
                </Link>
